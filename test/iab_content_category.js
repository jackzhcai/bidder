...
"IAB5-7 English as a 2nd Languag",
...
"IAB7-11 Cancer",
"IAB7-12 Cholesterol",
"IAB7-13 Chronic Fatigue Syndro",
...
"IAB25-2 Extreme Graphic/Explicit Violen",
"IAB25-3 Pornography",
...
for(var i=0;i<categories.length;i++){
	...
	var parent = code.split('-')[0];
	

	console.log([code,name,parent].join(','));
	//console.log("INSERT INTO `ymdsp`.`dsp_category`(`category_code`,`category_name`,`parent_category_code`,`created_time`,`created_by`,`updated_time`,`updated_by`)VALUES('"+code+"','"+name+"','"+parent +"',now(),1,now(),1);");
